...
data = load_dataset("mertkarabacak/NSQIP-ACC", data_files="acc_imputed.csv", use_auth_token = HF_TOKEN)
...
with gr.Blocks(title = "NSQIP-ACC") as demo:
    ...
    ## Short-Term Postoperative Outcomes Following Anterior Cervical Corpectomy
    ...
    **The publication describing the details of this predictive tool will be posted here upon the acceptance of publication.**
    ...
    with gr.Tab('Length of Stay'):
        ...
        ### Prolonged Length of Stay Prediction Model for ACC Surgery
